                ...
                case RUN_LENGTH:
                        {
                                ...
                                for(curr_channel=0; curr_channel<input_file_header->numChannels; curr_channel++) {
                                        ...
                                        b_to_uint32(&(output_buffer[curr_channel]), &(data_vector[curr_channel]), nbits_run + nbits_code, 0);
                                        bdestroy(&(output_buffer[curr_channel]));
                                        binit(&output_buffer[curr_channel], input_file_header->subchunk2size);
                ...
                case DELTA:
                        {
                                for(curr_channel=0; curr_channel<input_file_header->numChannels; curr_channel++) {
                                        ...
                                        for(curr_channel=0; curr_channel<input_file_header->numChannels; curr_channel++) {
                                                uint32_t size = ((output_buffer[curr_channel].n_bytes*8 - (8-output_buffer[curr_channel].bits_last))/(max_bits[curr_channel]));
                                                b_to_uint32(&(output_buffer[curr_channel]), &(data_vector[curr_channel]), max_bits[curr_channel], 0);
                                                bdestroy(&(output_buffer[curr_channel]));
                                                binit(&output_buffer[curr_channel], input_file_header->subchunk2size);
                                                hf_encode(data_vector[curr_channel], &output_buffer[curr_channel], &frequencies, size, pow(2, max_bits[curr_channel]));
            ...
            case DELTA:
                    {
                            ...
                            for(curr_channel=0; curr_channel<input_file_header->numChannels; curr_channel++) {
                                ...
                                bdestroy(&(output_buffer[curr_channel]));
                                binit(&(output_buffer[curr_channel]), input_file_header->subchunk2size);
                                rl_encode(&(data_buffer[curr_channel]), &(output_buffer[curr_channel]), max_bits[curr_channel], &nbits_run, &nbits_code);
                            }
            ...
            case -1:
                    {
                        ...
                        for(curr_channel=0; curr_channel<input_file_header->numChannels; curr_channel++) {
                                 ...
                                 binit(&(output_buffer[curr_channel]), input_file_header->subchunk2size);
                                 max_bits[curr_channel] = dt_encode(data_vector[curr_channel], &(output_buffer[curr_channel]), channel_size-1, input_file_header->bitsPerSample, firsts[curr_channel]);
                         }
                    }
                    break;
            ...
            case RUN_LENGTH:
                    {
                            ...
                            for(curr_channel=0; curr_channel<input_file_header->numChannels; curr_channel++) {
                                uint32_t size = b_to_uint32(&(output_buffer[curr_channel]), &(data_vector[curr_channel]), nbits_code + nbits_run, 0);
                                bdestroy(&(output_buffer[curr_channel]));
                                binit(&(output_buffer[curr_channel]), input_file_header->subchunk2size);
                                max_bits[curr_channel] = dt_encode(data_vector[curr_channel], &(output_buffer[curr_channel]), size, nbits_run+nbits_code, firsts[curr_channel]);
                            }
